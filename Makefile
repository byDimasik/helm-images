...
BUILD_WITH_FLAGS="-s -w -X 'github.com/byDimasik/helm-images/version.Version=${VERSION}' -X 'github.com/byDimasik/helm-images/version.Env=${BUILD_ENVIRONMENT}' -X 'github.com/byDimasik/helm-images/version.BuildDate=${DATE}' -X 'github.com/byDimasik/helm-images/version.Revision=${REVISION}' -X 'github.com/byDimasik/helm-images/version.Platform=${PlATFORM}/${ARCHITECTURE}' -X 'github.com/byDimasik/helm-images/version.GoVersion=${GOVERSION}'"
...
generate/document: ## generates cli documents using 'github.com/spf13/cobra/doc'.
	@go generate github.com/byDimasik/helm-images/docs
